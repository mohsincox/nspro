	    ...
	    <div class="row">
	        <div class="col-sm-12 offset-sm-0">
	            <div class="card text-white bg-info">
	                ...
	                <div class="card-body">
	                    {!! Form::open(['url' => 'report-single-profile-show-excel', 'method' => 'post', 'class' => 'form-horizontal' , 'onsubmit' => 'return validateForm()', 'name' => 'myForm']) !!}
	                    	<div class="row">
	                    		<div class="col-sm-6">
	                        ...
	                        <div class="form-group">
	                            <div class="col-sm-10 offset-sm-1">
	                                {!! Form::submit('Submit', ['class' => 'btn btn-dark btn-block', 'onclick' => 'return confirm("Do you want to download?");']) !!}
	                            </div>
	                        </div>
	                    {!! Form::close() !!}
	                    <p class=""><b><code style="font-size: 18px;">Note:</code></b> For <b><code style="font-size: 18px;">All Division, All District, All Thana,</code></b> please select <b><code style="font-size: 18px;">Start Date & End Date</code></b></p>
	                </div>
	            </div>
	        </div>
	    </div>
