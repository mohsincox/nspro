				...
				<div class="card-body">
					    ...
					    <div class="row"> 
					        ...
					        <div class="col-9 col-sm-9">
					        	<div class="col-12 col-sm-12">
					    	        {!! Form::select('division_id', $divisionList, null, ['class' => 'form-control', 'placeholder' => 'Select Division Name', 'ng-model' => 'selected', 'ng-change' => 'divisionSelect()']) !!}
					...
					<div class="form-group required {{ $errors->has('district_id') ? 'has-error' : '' }}">
					    <div class="row">
					        ...
					        <div class="col-9 col-sm-9">
					            <div class="col-12 col-sm-12">
					                <select class="form-control" name="district_id" ng-model="selected">
