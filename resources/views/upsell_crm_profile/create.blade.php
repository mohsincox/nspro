...
<html>
<head>
	<title>Upsell CRM Profile</title>
	<meta charset="utf-8">
	        ...
	        <div class="col-sm-12" style="padding-left: 0px; padding-right: 0px;">
	            ...
	            <div class="card bg-dark text-white">
	                ...
	                <div class="card-header" style="padding: 0px;">
	                	<img src="{{URL::asset('/assets/image/nestle.png')}}" alt="profile Pic" height="87" width="300" >
	                    <span class="float-right" style="padding: 22px; font-size: 22px;"><!-- <a href="http://192.168.100.16/nestle_all_crm/fnm_upsell/index.php" target="_blank" class="btn btn-danger">Upsel Link</a> --> Nestle Upsell CRM <small><?php echo 'Phone No: </small><code><b>'.$phoneNumber; ?></b></code> & <small><?php echo 'Agent:</small> <code><b>'.$agent; ?></b></code></span>
	                </div>
                            ...
                            <div class="col-sm-12" style="padding-left: 10px; padding-right: 10px;">
                                <div class="input-group mb-2 input-group-sm">
                                    <div class="input-group-prepend" style="flex: 0 0 12%;">
                                        <span class="input-group-text bg-success text-white">Select Product</span>
                                    </div>
                                    {!! Form::select('product_id', $deliveryProductList, null, ['class' => 'form-control select2', 'placeholder' => 'Select Product for add to Cart', 'required', 'id' => 'product_id']) !!}
                                </div>
                            </div>
	                    </div>
	                    ...
	                    <span id="quantity_error" class="text-danger"></span>
  						...
  						<div class="row">
                            <div class="col-sm-6" style="padding-left: 10px; padding-right: 10px;">
                                <div class="input-group mb-2 input-group-sm">
                                    <div class="input-group-prepend" style="flex: 0 0 25%;">
                                        <span class="input-group-text bg-success text-white">Quantiry</span>
                                    </div>
                                    {!! Form::number('quantity', null, ['class' => 'form-control', 'placeholder' => 'Enter Quantiry for add to Cart', 'step' => 'any', 'required', 'id' => 'quantity']) !!}
                                </div>
                            </div>
                            <div class="col-sm-6" style="padding-left: 10px; padding-right: 10px;">
                                {!! Form::button('<i class="fa fa-plus"></i> Submit for add to Cart', ['class' => 'btn btn-outline-danger btn-sm  btn-block add-cart-item-create', 'style' => 'color: #FFFFFF;']) !!}
                            </div>
	                    </div>
	                ...
	                <div class="card-body" style="padding: 5px;">
	                    {!! Form::model($profile, ['url' => 'upsell-crm-profile', 'method' => 'post']) !!}
	                    ...
	                    {!! Form::hidden('agent', null, ['class' => 'form-control', 'placeholder' => 'Enter Agent', 'autocomplete' => 'off']) !!}
	                        ...
	                        <div class="row">
	                            ...
	                            <div class="col-sm-6" style="padding-left: 10px; padding-right: 10px;">
	                                <div class="input-group mb-2 input-group-sm">
	                                    <div class="input-group-prepend">
	                                        <span class="input-group-text bg-danger text-white">Thana</span>
	                                    </div>
	                        ...
	                        <div class="row">
	                        	<div class="col-sm-6" style="padding-left: 10px; padding-right: 10px;">
	                                <div class="input-group mb-2 input-group-sm">
	                                    ...
	                                    @if(isset($upsellCrmLast))
	                                    	{!! Form::text('edu_qualification', $upsellCrmLast->edu_qualification, ['class' => 'form-control', 'placeholder' => 'Enter edu. Qalification', 'autocomplete' => 'off']) !!}
	                                    @else
	                            ...
	                            <div class="col-sm-6" style="padding-left: 10px; padding-right: 10px;">
	                                <div class="input-group mb-2 input-group-sm">
	                                    ...
	                                    @if(isset($upsellCrmLast))
	                                    	{!! Form::select('product_used', $productUsedList, $upsellCrmLast->product_used, ['class' => 'form-control', 'placeholder' => 'Select Product Used']) !!}
	                                    @else
	                        ...
	                        <div class="row">
	                            ...
	                            <div class="col-sm-6" style="padding-left: 10px; padding-right: 10px;">
	                                <div class="input-group mb-2 input-group-sm">
	                                    <div class="input-group-prepend">
	                                        <span class="input-group-text bg-danger text-white">Call Remaks</span>
	                                    </div>
	                                    {!! Form::select('call_remarks', $callRemarksList, null, ['class' => 'form-control', 'placeholder' => 'Select Call Remarks', 'required' => 'required']) !!}
	                                </div>
	                            </div>
	                        </div>
	                ...
	                <div class="table-responsive">
		                <table class="table table-sm table-striped table-bordered table-hover">
		                    ...
		                    <?php
		                        $i = 0;
		                    ?>
		                    @foreach($upsellCrms as $upsellCrm)
		                        <tr>
		                            <td>{{ ++$i }}</td>
		                            <td>{{ $upsellCrm->created_at }}</td>
		                            @if(isset($upsellCrm->brand->name))
		                            	<td>{{ $upsellCrm->brand->name }}</td>
		                            @else
		                            	<td></td>
		                            @endif
		                            <td>{{ substr($upsellCrm->product, strpos($upsellCrm->product, " ") + 1) }}</td>
		                            <td>{{ $upsellCrm->verbatim }}</td>
		                        </tr>
		                    @endforeach
		                    </tbody>
		                </table>
	 ...
	 //        	});
		...
		$(function() {
		    $(document).on('click', '.add-cart-item-create', function(e){
		        ...
		        var url = '{{ url("/upsell-crm-profile/add-to-cart")}}'
		...
		$(function() {
		    $(document).on('click', '.delete-cart-item', function(){
		        ...
		        var url2  = '{{ url("/upsell-crm-profile/remove-one-item")}}' + "/" + key_id;
		        console.log(url2);
